...
function Movie() {
    ...
    return (
        <>
            ...
            <div className=" text-white lg:px-[40px] px-[16px] min-h-screen bg-[#181818] mx-auto max-w-[1156px]">
                ...
                <div className="flex justify-center my-6">
                    <Link to={`/movie/category=${category}&page=${page - 1}`}>
                        <button className="movie-button-page">Previous</button>
                    </Link>
                    <span className="md:px-10 px-4 text-xl font-bold cursor-pointer tracking-wider">
                        {page} / {movie.total_pages}
                    </span>
                    <Link to={`/movie/category=${category}&page=${page + 1}`}>
                        <button className="movie-button-page">Next</button>
                    </Link>
                </div>
            </div>
        </>
