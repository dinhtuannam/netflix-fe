...
function Playlist() {
    ...
    const deletePlaylist = async (idMovie) => {
        ...
        if (res.result) handleDelete(idMovie);
    };
                            ...
                            <li className="setting-playlist-item" key={item.ID_Movie}>
                                ...
                                <div className="setting-playlist-info">
                                    ...
                                    <div className="playlist-btn-container">
                                        <Link to={`/watch/id=${item.ID_Movie}`}>
                                            <button className="setting-playlist-btnWatch">Watch Now</button>
                                        </Link>
                                        <button
                                            className="setting-playlist-btnDel"
                                            onClick={() => deletePlaylist(item.ID_Movie)}
                                        >
                                            Delete
                                        </button>
                                    </div>
